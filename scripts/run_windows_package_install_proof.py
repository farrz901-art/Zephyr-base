...
def main(argv: list[str] | None = None) -> int:
    ...
    sample_input.write_text(build_long_marker_text(FILE_MARKER, "Windows installer file smoke"), encoding="utf-8")
    ...
    if install_completed is not None and install_completed.returncode == 0:
        text_completed, text_flow = _run_flow(
            ...
            request_payload=_request_payload(
                ...
                inline_text=build_long_marker_text(TEXT_MARKER, "Windows installer text smoke"),
            ),
